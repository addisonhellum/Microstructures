...
public class MicroCreeper implements MicrostructurePreset {
    ...
    public MRData[] getRelatives() {
        return new MRData[] {
                ...
                new MRData(1, 0, 0), new MRData(0, -1, 0),
                new MRData(0, 2, 0), new MRData(-1, 0, 0),
                new MRData(-1, 0, 0), new MRData(-1, 0, 0),
                new MRData(1, 1, 0), new MRData(1, 0, 0),
                new MRData(-2, 1, 0), new MRData(-1, 0, 0),
                new MRData(0, 1, 0), new MRData(1, 0, 0),
                new MRData(3, 0, 0), new MRData(1, 0, 0),
                new MRData(0, -1, 0), new MRData(-1, 0, 0)
        };
    }

    public boolean useOrigin() { return false; }
    ...
    public Microstructure build(BlockTexture texture, Location location) {
        ...
        return new Microstructure("Creeper Face", location, contents);
    }
